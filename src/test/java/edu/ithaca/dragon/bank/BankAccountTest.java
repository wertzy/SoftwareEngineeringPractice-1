...
class BankAccountTest {
    ...
    void getBalanceTest() throws InsufficientFundsException {
        BankAccount bankAccount = new BankAccount("a@b.com", "abcdef1@", 200);
    ...
    void withdrawTest() throws InsufficientFundsException, FrozenAccountException {
        ...
        BankAccount bankAccount3 = new BankAccount("a@b.com", "abcdef1@", 1);
    ...
    void constructorTest() throws InsufficientFundsException, FrozenAccountException {
        ...
        assertThrows(IllegalArgumentException.class, ()-> new BankAccount("a@b.com", "abcdef1@",-100));
        //check for more than 2 decimal places
        assertThrows(IllegalArgumentException.class, ()-> new BankAccount("a@b.com", "abcdef1@", 0.001));
    }
    ...
    void transferTest() throws InsufficientFundsException, FrozenAccountException {
        BankAccount bankAccount = new BankAccount("a@b.com", "abcdef1@", 500);
        BankAccount otherBankAccount = new BankAccount("a@b.com", "abcdef1@", 500);
